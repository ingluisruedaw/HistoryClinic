...
<table id="data-table-simple" class="responsive-table display" cellspacing="0">
            ...
            <form id="form_editar" name="form_editar" action="?action=tratamiento_actualizar" method="post">
            ...
            <form id="tuformulario" name="tuformulario" action="?action=tratamiento_eliminar" method="post">
              <input id="accion_eliminar_tratamiento" name="accion_eliminar_tratamiento" type="hidden" />
            </form>
            ...
            <script>
              $(document).ready(function(){
                  $(".boton").click(function(){
                      ...
                      function(){
                        document.getElementById("accion_eliminar_tratamiento").value=seleccionada;
