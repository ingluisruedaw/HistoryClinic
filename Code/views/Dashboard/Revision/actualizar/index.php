<?php  
    ...
    if($_REQUEST['id']==null){
      header('Location: ?action=revision_index');
  }
?>
...
<div id="main">
  ...
  <section id="content">
    <?php 
      require('views/Dashboard/Revision/actualizar/rutas.php');
    ?>
    <br>
    <div align="center">
      <?php require('views/Dashboard/Revision/actualizar/formulario.php');?>
    </div>
  </section>
</div><!-- END MAIN -->
