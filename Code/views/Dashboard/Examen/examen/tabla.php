...
<table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelExamen->Listar($_REQUEST['id']) as $r): ?>
                  <tr>
            ...
            <form id="form_editar" name="form_editar" action="?action=examen_actualizar" method="post">
            ...
            <form id="tuformulario" name="tuformulario" action="?action=examen_eliminar" method="post">
              <input id="accion_eliminar_examen" name="accion_eliminar_examen" type="hidden" />
            </form>
            ...
            <script>
              $(document).ready(function(){
                  $(".boton").click(function(){
                      ...
                      function(){
                        document.getElementById("accion_eliminar_examen").value=seleccionada;
