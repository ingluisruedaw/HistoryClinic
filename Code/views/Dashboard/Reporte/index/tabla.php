  ...
  <tbody>
    <?php foreach($modelHistoria_clinica->Listar() as $r): ?>
      <tr>
        ...
        <td class="boton">
          <a type="button" class="btn-floating btn-small waves-effect waves-light green"><i class="mdi-file-cloud-download"></i></a>
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
...
<form id="tuformulario" name="tuformulario" action="?action=reporte" target="_blank" method="post">
