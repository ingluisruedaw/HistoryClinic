<?php  
    ...
    if($_REQUEST['id']==null){
      header('Location: ?action=evolucion_index');
  }
?>
...
<div id="main">
  ...
  <section id="content">
    <?php 
      require('views/Dashboard/Evolucion/actualizar/rutas.php');
    ?>
    <br>
    <div align="center">
      <?php require('views/Dashboard/Evolucion/actualizar/formulario.php');?>
    </div>
  </section>
</div><!-- END MAIN -->
