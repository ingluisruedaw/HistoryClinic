...
<table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelImpresion->Listar($_REQUEST['id']) as $r): ?>
                  <tr>
            ...
            <form id="form_editar" name="form_editar" action="?action=impresion_actualizar" method="post">
            ...
            <form id="tuformulario" name="tuformulario" action="?action=impresion_eliminar" method="post">
              <input id="accion_eliminar_impresion" name="accion_eliminar_impresion" type="hidden" />
            </form>
            ...
            <script>
              $(document).ready(function(){
                  $(".boton").click(function(){
                      ...
                      function(){
                        document.getElementById("accion_eliminar_impresion").value=seleccionada;
