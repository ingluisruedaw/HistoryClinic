<?php  
    ...
    if($_REQUEST['id']==null){
      header('Location: ?action=impresion_index');
  }
?>
...
<div id="main">
  ...
  <section id="content">
    <?php 
      require('views/Dashboard/Impresion/actualizar/rutas.php');
    ?>
    <br>
    <div align="center">
      <?php require('views/Dashboard/Impresion/actualizar/formulario.php');?>
    </div>
  </section>
</div><!-- END MAIN -->
