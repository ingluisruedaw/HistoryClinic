...
<table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelAntecedentes->Listar($_REQUEST['id']) as $r): ?>
                  <tr>
            ...
            <form id="form_editar" name="form_editar" action="?action=antecedentes_actualizar" method="post">
            ...
            <form id="tuformulario" name="tuformulario" action="?action=antecedentes_eliminar" method="post">
              <input id="accion_eliminar_antecedente" name="accion_eliminar_antecedente" type="hidden" />
            </form>
            ...
            <script>
              $(document).ready(function(){
                  $(".boton").click(function(){
                      ...
                      function(){
                        document.getElementById("accion_eliminar_antecedente").value=seleccionada;
