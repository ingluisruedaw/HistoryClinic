...
<table id="data-table-simple" class="responsive-table display" cellspacing="0">
            ...
            <form id="form_editar" name="form_editar" action="?action=motivo_actualizar" method="post">
            ...
            <form id="tuformulario" name="tuformulario" action="?action=motivo_eliminar" method="post">
              <input id="accion_eliminar_motivo" name="accion_eliminar_motivo" type="hidden" />
            </form>
            ...
            <script>
              $(document).ready(function(){
                  $(".boton").click(function(){
                      ...
                      function(){
                        document.getElementById("accion_eliminar_motivo").value=seleccionada;
